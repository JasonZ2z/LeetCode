 ...
 * @date 2020/9/10
 * Title : 1025. 除数博弈
 * Description : 爱丽丝和鲍勃一起玩游戏，他们轮流行动。爱丽丝先手开局。最初，黑板上有一个数字 N 。在每个玩家的回合，玩家需要执行以下操作：
...
public class Leetcode_weekly_13201 {
    public static void main(String[] args) {
        Leetcode_weekly_13201 lc = new Leetcode_weekly_13201();
    }
