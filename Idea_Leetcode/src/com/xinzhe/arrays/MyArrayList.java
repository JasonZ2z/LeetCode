...
public class MyArrayList<E> extends MyAbstractList<E> implements List<E>, RandomAccess, Cloneable, java.io.Serializable{
    ...
    /**
     * Increases the capacity of this {@code MyArrayList} instance, if
    ...
    /**
     * Returns a shallow copy of this {@code MyArrayList} instance.  (The
     * elements themselves are not copied.)
     *
     * @return a clone of this {@code MyArrayList} instance
     */
    public Object clone() {
        try {
    ...
    public boolean equals(Object o) {
        ...
        // MyArrayList can be subclassed and given arbitrary behavior, but we can
        // still deal with the common case where o is MyArrayList precisely
        boolean equal = (o.getClass() == MyArrayList.class)
                ? equalsMyArrayList((MyArrayList<?>) o)
    ...
    private boolean equalsMyArrayList(MyArrayList<?> other) {
    ...
    /**
     * Saves the state of the {@code MyArrayList} instance to a stream
     * (that is, serializes it).
     *
     * @param s the stream
     * @throws java.io.IOException if an I/O error occurs
     * @serialData The length of the array backing the {@code MyArrayList}
    ...
    /**
     * Reconstitutes the {@code MyArrayList} instance from a stream (that is,
     * deserializes it).
     * @param s the stream
    ...
    private static class SubList<E> extends AbstractList<E> implements RandomAccess {
        ...
        private final MyArrayList.SubList<E> parent;
        private final int offset;
        private int size;

        /**
         * Constructs a sublist of an arbitrary MyArrayList.
         */
        public SubList(MyArrayList<E> root, int fromIndex, int toIndex) {
            this.root = root;
            this.parent = null;
         ...
         */
        private SubList(MyArrayList.SubList<E> parent, int fromIndex, int toIndex) {
        ...
        private void updateSizeAndModCount(int sizeChange) {
            MyArrayList.SubList<E> slist = this;
            do {
        ...
        public Spliterator<E> spliterator() {
            ...
            // MyArrayListSpliterator not used here due to late-binding
            return new Spliterator<E>() {
                ...
                public MyArrayList<E>.MyArrayListSpliterator trySplit() {
                    int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
                    // MyArrayListSpliterator can be used here as the source is already bound
                    return (lo >= mid) ? null : // divide range in half unless too small
                            root.new MyArrayListSpliterator(lo, index = mid, expectedModCount);
                }
    ...
    @Override
    public Spliterator<E> spliterator() {
        return new MyArrayList.MyArrayListSpliterator(0, -1, 0);
    }
    ...
    final class MyArrayListSpliterator implements Spliterator<E> {
        ...
        MyArrayListSpliterator(int origin, int fence, int expectedModCount) {
            this.index = origin;
            this.fence = fence;
        ...
        public MyArrayList.MyArrayListSpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid) ? null : // divide range in half unless too small
                    new MyArrayList.MyArrayListSpliterator(lo, index = mid, expectedModCount);
        }
